            ...
            <div> 
                <ul id="nav" className="text-red-800 text-6xl font-adamcg items-center mb-20 flex gap-10 justify-center">
                    <li>
                        ...
                        <label for="color" onClick={() => changeArtData('color')} className="peer-checked:text-white peer-checked:underline">Coloridos</label>
                    </li>
                    <li>
                        <input type="radio" id="sketch" name="nav" className="sr-only peer"/>
                        <label for="sketch" onClick={() => changeArtData('sketch')} className="peer-checked:text-white peer-checked:underline">Sketchs</label>
                    </li>
                    <li>
                        <input type="radio" id="splash" name="nav"  className="sr-only peer"/>
                        <label for="splash" onClick={() => changeArtData('splash')} className="peer-checked:text-white peer-checked:underline peer-checked">Splash Arts</label>
                    </li>
                </ul>
            </div>        
