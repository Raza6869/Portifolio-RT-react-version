export default function Contact() {
    return(
        <div id='box' className='bg-contact bg-cover p-20 flex flex-row-reverse h-screen'>
          <forms className="flex flex-col gap-10 p-10 w-1/2 py-10 bg-red-700 rounded-xl mr-14">
